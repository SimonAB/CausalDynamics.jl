...
include("test_clarity_surface.jl")
include("test_semantic_contract.jl")
include("test_scm.jl")
include("test_cdm.jl")
...
include("test_exact_abstraction.jl")
include("test_structural_constraints.jl")
include("test_intervention_algebra.jl")
include("test_cdm_typed_surgery.jl")
...
include("test_boosted_control_functions.jl")
