...
"""Map one declared temporal node to its wide-panel column name."""
function _panel_column(
    unrolling::TemporalUnrolling,
    variable::Symbol,
...
"""
    query_panel_columns(unrolling, query::TemporalEffectQuery; name_fn) -> NamedTuple
