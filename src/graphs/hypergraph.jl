...
**Experimental.** A hypergraph with vertices, edges, and hyperedges for modeling
higher-order interactions. Not wired into `identify` / backdoor / CDM pipelines;
prefer `SimpleDiGraph` for identification and simulation.
