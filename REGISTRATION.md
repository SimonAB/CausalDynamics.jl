...
CausalDynamics.jl **v0.3.3** is ready to submit to the Julia General registry.
...
| Item | Status | Action |
|------|--------|--------|
| CausalDynamics General registration | Pending | Install [JuliaRegistrator](https://github.com/JuliaRegistries/Registrator.jl) on `SimonAB/CausalDynamics.jl`; comment `@JuliaRegistrator register` on [issue #1](https://github.com/SimonAB/CausalDynamics.jl/issues/1) after tagging `v0.3.3` |
